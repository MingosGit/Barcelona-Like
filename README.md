...
| Menú | Les Rambles | El Gòtic de noche | El Raval | El Turista Definitivo | La Obra Interminable |
|---|---|---|---|---|---|
| ![Menú](docs/img/menu.png) | ![Rambles](docs/img/ramblas_vivas.png) | ![Gòtic](docs/img/gotic_noche.png) | ![Raval](docs/img/raval.png) | ![Boss intro](docs/img/boss_intro.png) | ![Grúa](docs/img/obra_interminable.png) |
...
- **38 enemigos** de todas las tribus urbanas y del submundo profundo: el **Galán del Portal** que te aturde a piropos y se cobra el espectáculo, los **Mellizos del Gym** que te hacen la pinza A LA VEZ, el del **After Eterno** (illo, ¿qué día es hoy?), el **Meador Fantasma** y sus charcos sospechosos, el **"Yo Solo Pasaba" de Robadors** que SOLO avanza cuando no le miras (ángel llorón de barrio), la **Montse de Tota la Vida** cuya bronca en catalán te drena la vida pero nunca te remata ("te deja vivo para que aprendas")…
- Además de todas las tribus urbanas: la banda del altavoz (el bajo te ralentiza físicamente), el de "dame todo", el ciclista de Strava, la señora del carrito, el trilero, la gaviota psicópata que te roba XP, el promotor de discoteca que te ARRASTRA a su lista VIP, el camarero de cuentas infladas teledirigidas, el crucerista con 45 minutos para "hacer" Barcelona… Y la fauna de verdad: **ratas de Ciutat Vella** (empadronadas desde 1714), **cucarachas de bar de menú**, **palomas de plaça Catalunya** en escuadrón y el **top manta desplegado** que monta la tienda en tu camino y la pliega en 0,2 s si te acercas.
- **Cada enemigo te saluda con SU frase al verte** ("Amego... ¿segarro?", "¡¿Y LA VTC QUÉEEE?!", "¡BRO! Entrada GRATIS bro") y la calle tiene vida propia: palomas picoteando que huyen de ti, ratas cruzando, terrazas con menú a 14,50€ (antes 9,90), ropa tendida, estaciones de Bicing sin bicis y graffitis de "TOURIST GO HOME* (*escrito por un erasmus)".
